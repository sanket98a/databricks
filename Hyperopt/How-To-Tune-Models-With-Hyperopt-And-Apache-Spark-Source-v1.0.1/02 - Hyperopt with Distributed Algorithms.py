...
#%fs ls "dbfs:/user/sanket.bodake@affine.ai/dbacademy/how_to_tune_models_with_hyperopt_and_apache_spark/datasets"
...
best_params = fmin(
  ...
  algo=tpe.suggest, 
  max_evals=25,
  rstate=np.random.RandomState(13,seed='MT19937 '),
  trials=trials
  )
