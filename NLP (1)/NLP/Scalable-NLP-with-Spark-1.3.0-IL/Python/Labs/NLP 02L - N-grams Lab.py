...
ngram2 = NGram(n=2, inputCol="CleanTokens", outputCol="bigram")
ngram3 = NGram(n=3, inputCol="CleanTokens", outputCol="trigram")
...
ngramDF = ngramDF.withColumn(
    "ngrams", concat(col("tokens"), col("bigram"), col("trigram"))
)
